...
export const GuildMenuItem: FC<GuildMenuItemProps> = ({ guild }) => {
  ...
  return (
      ...
      <Link href={`/dashboard/${guild.id}`}>
        <div className="border border-gray-700 rounded-lg p-4 mb-4 text-white cursor-pointer flex items-center space-x-4 hover:bg-gray-700 transition duration-300">
